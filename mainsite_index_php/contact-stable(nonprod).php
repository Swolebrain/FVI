	...
	<div class="container">
        ...
        <div class="col-lg-12 inner-content">
            ...
            <div class="col-md-8 cont-right">
                ...
                <div class="col-md-7">
                   <form name="sentMessage" id="contactForm" novalidate action="mail.php" id="frm_post" onSubmit="return CheckForm(this);">
                        ...
                        <div class="control-group form-group">
                            ...
                            <div class="controls">
                                <input type="tel" class="form-control phon-form" placeholder="---" id="phone1" required data-validation-required-message="Please enter your phone number.">
...
<option value="4826">Medical Assistant Online</option>
                    ...
                    <option value="2212">Patient Care Technician</option>
                        ...
                        <button type="submit" class="btn btn-rounded submit btn-primary">Submit <i class="fa fa-long-arrow-right"></i></button>
                        <div class="control-group form-group">
                        </div>
                    </form>
                   <?php the_content(); ?>
